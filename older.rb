...
module Older
  ...
  @m_avg  = reader_to_f('assets/type/older/intake_average_male.txt')
  @m_high = reader_to_f('assets/type/older/intake_high_male.txt')
  @f_avg  = reader_to_f('assets/type/older/intake_average_female.txt')
  @f_high = reader_to_f('assets/type/older/intake_high_female.txt')
  @avg    = reader_to_f('assets/type/older/intake_average.txt')
  @high   = reader_to_f('assets/type/older/intake_high.txt')
