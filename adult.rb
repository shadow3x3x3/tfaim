...
module Adult
  ...
  @m_avg  = reader_to_f('assets/type/adult/intake_average_male.txt')
  @m_high = reader_to_f('assets/type/adult/intake_high_male.txt')
  @f_avg  = reader_to_f('assets/type/adult/intake_average_female.txt')
  @f_high = reader_to_f('assets/type/adult/intake_high_female.txt')
  @avg    = reader_to_f('assets/type/adult/intake_average.txt')
  @high   = reader_to_f('assets/type/adult/intake_high.txt')
